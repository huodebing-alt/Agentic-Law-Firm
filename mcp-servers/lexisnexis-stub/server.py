...
def _stub_response(args: dict) -> dict:
    return {
        "status": "stub",
        "server": "lexisnexis-stub",
        "args": args,
        "result": {"results": [{"title": "[STUB] Sample GDPR enforcement decision", "citation": "[STUB] ..."}]},
        "note": "Replace with real backend; see README.md alongside this server.",
    }


if FastMCP is not None:
    mcp = FastMCP("lexisnexis-stub")

    @mcp.tool()
    def lexis_search(query: str = "", jurisdiction: str = "", limit: str = "") -> dict:
        """Search LexisNexis for cases and statutes."""
