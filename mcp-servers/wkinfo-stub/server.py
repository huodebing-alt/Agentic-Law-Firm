...
def _stub_response(args: dict) -> dict:
    return {
        ...
        "server": "wkinfo-stub",
        "args": args,
        "result": {"results": [{"title": "[STUB] 个人信息保护法相关检索结果"}]},
        "note": "Replace with real backend; see README.md alongside this server.",
    }


if FastMCP is not None:
    mcp = FastMCP("wkinfo-stub")

    @mcp.tool()
    def wkinfo_search(query: str = "", limit: str = "") -> dict:
        """Search WKInfo for statutes and cases. Returns title and snippet."""
